...
#' }
#'
#' @param data A data frame with normalized scores (usually in \code{[0, 1]}) as columns.
...
#' @param type Either "standard" for the standard coupling formula (results concentrated near 1) or "adjusted" for the revised formula (results more uniformly distributed in \code{[0, 1]}), as proposed by Wang Shujia, Kong Wei, et al. in "Misconceptions and Corrections of Domestic Coupling Coordination Degree Models, Journal of Natural Resources, 2021, 36(3): 793–810 (In Chinese)"
#'
#' @return
...
#' @param scaled Logical. Whether to perform row normalization on obstacle degrees (default FALSE).
#' @rdname system_evaluation
#' @export
