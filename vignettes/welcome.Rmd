...
The `mathmodels` package is developed as a companion to the book "[Mathematical Modeling: Algorithms and Programming Implementation](https://item.jd.com/13272295.html)" (China Machine Press). The current version (0.0.6) focuses on **evaluation algorithms**, offering a complete suite of solutions from data preprocessing to comprehensive evaluation.
