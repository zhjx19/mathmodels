...
- `rescale_interval`: Interval-type normalized values in 0, 1, where 1
  indicates `x` in `[a, b]`.
...
- `rescale`: Performs Min-Max scaling to a specified range (default 0,
  1), supporting positive or negative indicators.
